...
if not exist HRIDtxt_To_IT mkdir HRIDtxt_To_IT
...
copy C:\j750\STDF\CP\L022\Backup_gzip\*_HRID.txt.gz C:\j750\STDF\CP\L022\HRIDtxt_To_IT
...
C:\j750\STDF\CP\ncftpput -u sghpe2 -p sgh555pe2 -DD 192.168.1.76 /HRID/AF10687/ C:\j750\STDF\CP\L022\HRIDtxt_To_IT\*.txt.gz
